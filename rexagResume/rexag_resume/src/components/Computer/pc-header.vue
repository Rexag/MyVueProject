  ...
  <div class="header-box">
    ...
    <nav class="page">
      <ul class="page__ul">
        <li class="page__li">
          <div>
            <router-link class="page__link" :to="routerName.home">
              <img
        ...
        <li class="page__li">
          <div>
            <router-link class="page__link" :to="routerName.info">
              <img
        ...
        <li class="page__li">
          <div>
            <router-link class="page__link" :to="routerName.skills">
              <img
        ...
        <li class="page__li">
          <div>
            <router-link class="page__link" :to="routerName.exp">
              <img
        ...
        <li class="page__li">
          <div>
            <router-link class="page__link" :to="routerName.works">
              <img
        ...
        <li class="page__li">
          <div>
            <router-link class="page__link" :to="routerName.contact">
              <img
